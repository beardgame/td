...
readonly struct TileCorner : IEquatable<TileCorner>
{
    ...
    public static TileCorner FromTileAndDirectionBefore(Tile tile, Direction direction)
    {
        return direction switch
        {
            ...
            Direction.UpLeft => new(tile.Neighbor(Direction.Left), Corner.UpRight),
    ...
    {
        Corner.UpRight => (
            TileEdge.From(tile.Neighbor(Direction.Right), Direction.UpLeft),
            TileEdge.From(tile, Direction.UpRight),
            TileEdge.From(tile, Direction.Right)
        ),
        Corner.Up => (
            TileEdge.From(tile.Neighbor(Direction.UpLeft), Direction.Right),
