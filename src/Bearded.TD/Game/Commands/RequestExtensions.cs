...
namespace Bearded.TD.Game.Commands
{
    static class RequestExtensions
    {
        ...
        public static void Request(this GameInstance game, Func<GameState, IRequest<Player, GameInstance>> func)
            => game.Request(func(game.State));
        public static void Request<T>(this GameInstance game, Func<GameState, T, IRequest<Player, GameInstance>> func, T p)
            => game.Request(func(game.State, p));
        public static void Request<T1, T2>(this GameInstance game, Func<GameState, T1, T2, IRequest<Player, GameInstance>> func, T1 p1, T2 p2)
            => game.Request(func(game.State, p1, p2));
        public static void Request<T1, T2, T3>(this GameInstance game, Func<GameState, T1, T2, T3, IRequest<Player, GameInstance>> func, T1 p1, T2 p2, T3 p3)
