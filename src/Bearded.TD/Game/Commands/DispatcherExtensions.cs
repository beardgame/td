...
namespace Bearded.TD.Game.Commands
{
    static class DispatcherExtensions
    {
        ...
        public static void Sync<T>(this T obj, Action<GameState.GameState> action)
            where T : GameObject
        ...
        public static void Sync<T>(this T obj, Action<T, ICommandDispatcher<GameInstance>> action)
            where T : GameObject
            => d(obj).RunOnlyOnServer(action, obj);
        public static void Sync<T>(this T obj, Action<GameState.GameState, ICommandDispatcher<GameInstance>> action)
            where T : GameObject
            => d(obj).RunOnlyOnServer(action, obj.Game);
        ...
        public static void Sync<T>(this T obj, Func<GameState.GameState, ISerializableCommand<GameInstance>> func)
            where T : GameObject
            => d(obj).RunOnlyOnServer(func, obj.Game);
        public static void Sync<T, T1>(this T obj, Func<GameState.GameState, T1, ISerializableCommand<GameInstance>> func, T1 p1)
            where T : GameObject
            => d(obj).RunOnlyOnServer(func, obj.Game, p1);
        public static void Sync<T, T1, T2>(this T obj, Func<GameState.GameState, T1, T2, ISerializableCommand<GameInstance>> func, T1 p1, T2 p2)
            where T : GameObject
            => d(obj).RunOnlyOnServer(func, obj.Game, p1, p2);
        public static void Sync<T, T1, T2, T3>(this T obj, Func<GameState.GameState, T1, T2, T3, ISerializableCommand<GameInstance>> func, T1 p1, T2 p2, T3 p3)
            where T : GameObject
