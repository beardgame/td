...
namespace Bearded.TD.Game.Commands
{
    ...
    {
        public static IRequest<GameInstance> Request(GameState game, Tile tile, TileType type, TileDrawInfo drawInfo)
        ...
        private class Implementation : UnifiedDebugRequestCommand
        {
            ...
            public Implementation(GameState game, Tile tile, TileType type, TileDrawInfo drawInfo)
            {
                this.game = game;
                this.tile = tile;
                this.type = type;
        ...
        private class Serializer : UnifiedRequestCommandSerializer
        {
            ...
            public Serializer(Tile tile, TileType type, TileDrawInfo drawInfo)
            {
                x = tile.X;
                y = tile.Y;
                this.type = type;
