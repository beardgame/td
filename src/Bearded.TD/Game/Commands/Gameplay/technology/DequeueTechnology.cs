...
{
    static class DequeueTechnology
    {
        ...
        private class Implementation : UnifiedRequestCommand
        {
            ...
            public override bool CheckPreconditions(Player actor) =>
                faction.SharesTechnologyWith(actor.Faction) && faction.Technology.IsTechnologyQueued(technology);

            public override void Execute()
            {
                faction.Technology.DequeueTechnology(technology);
            }
