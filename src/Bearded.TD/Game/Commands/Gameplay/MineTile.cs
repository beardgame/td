...
namespace Bearded.TD.Game.Commands
{
    ...
    {
        public static IRequest<GameInstance, Player> Request(GameInstance game, Faction faction, Tile<TileInfo> tile)
        ...
        private class Implementation : UnifiedRequestCommand
        {
            ...
            {
                return tile.IsValid && tile.Info.TileType == TileInfo.Type.Wall;
            }
