...
namespace Bearded.TD.Game.Upgrades
{
    ...
    {
        public virtual bool CanApplyTo(IAttributeModifiable subject) => false;
        ...
        public virtual void ApplyTo(IAttributeModifiable subject)
        {
            throw new System.InvalidOperationException("Cannot apply upgrade effect to subject.");
        }
