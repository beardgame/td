...
interface IBuildBuildingPrecondition
{
    ...
    public readonly record struct Result(bool IsValid, ImmutableArray<Tile> BadTiles, ImmutableArray<TileEdge> BadEdges)
    {
        ...
        public static Result FromBool(bool isValid)
            => new (isValid, ImmutableArray<Tile>.Empty, ImmutableArray<TileEdge>.Empty);
