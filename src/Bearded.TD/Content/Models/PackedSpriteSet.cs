...
namespace Bearded.TD.Content.Models
{
    sealed class PackedSpriteSet
    {
        ...
        public ExpandingIndexedTrianglesMeshBuilder<UVColorVertexData> MeshBuilder { get; }
        ...
        public PackedSpriteSet(IEnumerable<Texture> textures, ExpandingIndexedTrianglesMeshBuilder<UVColorVertexData> meshBuilder,
