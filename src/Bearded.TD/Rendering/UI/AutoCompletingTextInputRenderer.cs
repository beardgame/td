...
sealed class AutoCompletingTextInputRenderer(IShapeDrawer shapeDrawer, UIFonts fonts)
    : IRenderer<AutoCompletingTextInput>
{
    private readonly TextInputRenderer internalRenderer = new(shapeDrawer, fonts);
