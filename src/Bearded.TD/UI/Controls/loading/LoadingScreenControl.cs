...
namespace Bearded.TD.UI.Controls
{
    sealed class LoadingScreenControl : CompositeControl
    {
        ...
        {
            var listControl = new ListControl(startStuckToBottom: true);
            Add(listControl);

            model.ModLoadingUpdated += () =>
                listControl.ItemSource =
                    new LoadingBlueprintsListSource(model.LoadedBlueprints, model.LoadingBlueprints);
        }
